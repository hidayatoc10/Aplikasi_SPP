            ...
            <div class="card" id="settings-card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-md-9 custom-select-icon" wire:ignore>
                            <select name="level" class="custom-select" id="level" wire:model="level">
                                ...
                                @foreach ($levels as $key => $name)
                                    <option value="{{ $key }}" {{ $key == $setting->level ? 'selected' : '' }}>
                                        {{ $name }}</option>
                                @endforeach
                            </select>
                            @error('level')
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                            <input type="number" name="phone" wire:model.defer='phone' class="form-control"
                                id="phone">
                        </div>
                        @error('phone')
                            <small class="text-validate-error">{{ $message }}</small>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                            <input type="number" name="fax" wire:model.defer='fax' class="form-control"
                                id="fax">
                        </div>
                        @error('fax')
                            <small class="text-validate-error">{{ $message }}</small>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                            <input type="number" name="code" wire:model.defer='code' class="form-control"
                                id="code">
                        </div>
                        @error('code')
                            <small class="text-validate-error">{{ $message }}</small>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <x-modals.modal id="img" title="Logo Sekolah">
                            <form>
                                <x-slot name="body">
                                    <img src="{{ asset('storage/uploads/logo/' . $this->logo) }}" alt="Logo"
                                        width="50%">
                                </x-slot>
                                <x-slot name="footer">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                            <input type="text" name="city_name" wire:model.defer='city_name' class="form-control"
                                id="city_name">
                            @error('city_name')
                                <small class="text-validate-error">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                            <textarea name="address" wire:model.defer='address' id="address" class="form-control" style="min-height: 120px;"></textarea>
                            @error('address')
                                <small class="text-validate-error">{{ $message }}</small>
                            @enderror
                        </div>
